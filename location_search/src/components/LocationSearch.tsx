  ...
  return (
    <div>
      <form onSubmit={handleSubmit}>
        ...
        <input className="border border-gray-300 rounded-md shadow-sm focus:border-indigo-400 px-4 py-2 w-full"
          id="term"
          value={term}
          onChange={e => setTerm(e.target.value)}  />
      </form>
      {places.length > 0 && <h1 className="font-bold mt-6">Found Locations</h1>}
